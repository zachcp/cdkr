...
* minor update to make bond order enums available when setting the order of pre-existing bonds
...
functions to utilize descriptor names and in general make descriptor calculations
more R-like
